...
<div class="wrapper">
 ...
 <form id="contact" action="mail.php" method="post">
        <h1>Task Form</h1>
        <div class="input-box">
            <input type="text" name="name" type="text" placeholder="Task name" tabindex="1" autofocus>
</div>
...
?>
        ...
        <div class="input-box">
            ...
            <select id="task_type" name="task_type" tabindex="3" style="width: 350px;height:50px">
    ...
    <br>
        ...
        <input type="submit" name="send" id="contact-submit"></button>
